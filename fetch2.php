<?php
    ...
    extract($_POST);
    $query = "SELECT * FROM t_fi001_detail where id_p=$id_p and type_F='pratique'";
    ...
    $(".text").show();
     ...
     $('#add3').click(function(){
        ...
        count = count + 1;
            ...
            html_code += "<td><button type='button' onclick='save_data()' data-id2='<?php echo $id_p ?>' class=' save_f btn btn-success'>Save</button></td>"
            html_code += "</tr>";  
            $('#tab3 tr:first').after(html_code);
        });
        function save_data(){
...
if(date_debut>date_fin){
    alert("erreur please correct date ");
}else{
$.ajax({
url:"insert_f.php",
method:"POST",
...
<body>
    <div class="container">
        ...
        <table class="table text-center table-striped table-bordered" id="tab3">
            <tr>
                <th>Date Debut</th>
                <th>Date Fin</th>
                <th>Objet</th>
           ...
           ';
            ...
            <tr>
                ...
                <th>Lieu</th>
                <th>Formateur</th>
                <th><button type="button" name="add" id="add3" class="btn btn-success">+</button></th>
        ...
        if (mysqli_num_rows($result)>0) {
                while($row = mysqli_fetch_array($result)){
                    echo "<tr class='2edit_tr' data-id='".$etat."' data-id2='".$row["id"]."'>";                   
